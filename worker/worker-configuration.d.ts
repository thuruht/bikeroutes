/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b3f2b969f3eb566b05b2f789ba66058)
...
interface __BaseEnv_Env {
	...
	TILES: R2Bucket;
	DB: D1Database;
	TRAIL_SEARCH: VectorizeIndex;
	AI: Ai;
	ASSETS: Fetcher;
	PAYPAL_CLIENT_ID: string;
	PAYPAL_CLIENT_SECRET: string;
	POI_STORE: DurableObjectNamespace<import("./src/index").POIStore>;
	ROUTE_SESSION: DurableObjectNamespace<import("./src/index").RouteSession>;
	VALHALLA: DurableObjectNamespace<import("./src/index").ValhallaContainer>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYPAL_CLIENT_ID" | "PAYPAL_CLIENT_SECRET">> {}
}
